...
CKEDITOR.editorConfig = function( config ) {
    config = {
        ...
        basicEntities: true,
        blockedKeystrokes: [CKEDITOR.CTRL + 66,
        CKEDITOR.CTRL + 73,
        CKEDITOR.CTRL + 85],
        ...
        fontSize_sizes: '12px;2.3em;130%;larger;x-small',
        font_names: 'Arial;TimesNewRoman;Verdana',
        ...
        image_previewText: 'Loremipsumdolor...',
        ...
        magicline_putEverywhere: false,
        magicline_triggerOffset: 30,
        menu_groups: 'clipboard, tablecell, tablecellproperties, tablerow, tablecolumn, table, anchor, link, image, flash, checkbox, radio, textfield, hiddenfield, imagebutton, button, select, textarea, div',
        ...
        protectedSource: [(/<iclass[\s\S]*?>[\s\S]*?<\/i>/gi),
        (/<spanclass[\s\S]*?>[\s\S]*?<\/span>/gi),
        (/<emclass[\s\S]*?>[\s\S]*?<\/em>/gi),
        (/<buttonclass[\s\S]*?>[\s\S]*?<\/button>/gi)],
        readOnly: false,
